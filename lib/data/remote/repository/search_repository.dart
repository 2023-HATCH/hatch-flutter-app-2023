...
class SearchRepository {
  ...
  Future<List<String>> getTags() async {
    ...
    if (response.statusCode == 200) {
      ...
      debugPrint("검색 태그 목록 조회 실패! json: $json");
      throw Exception(
          'moon error! lib/data/remote/repository/search_repository.dart');
    }
  }
  ...
  Future<VideosResponse> getRandomVideos(VideosRequest videosRequest) async {
    ...
    if (response.statusCode == 200) {
      ...
      debugPrint("검색 랜덤 비디오 목록 조회 실패! json: $json");
      throw Exception(
          'moon error! lib/data/remote/repository/search_repository.dart');
    }
  }
  ...
  Future<List<SearchUserData>> getUserSearch(String key) async {
    ...
    if (response.statusCode == 200) {
      ...
      debugPrint("검색 사용자 목록 조회 실패! json: $json");
      throw Exception(
          'moon error! lib/data/remote/repository/search_repository.dart');
    }
  }
  ...
  Future<VideosResponse> getTagSearch(
    ...
    if (response.statusCode == 200) {
      ...
      debugPrint("검색 태그 비디오 목록 조회 실패! json: $json");
      throw Exception(
          'moon error! lib/data/remote/repository/search_repository.dart');
    }
  }
